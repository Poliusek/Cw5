...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(x => x.HireDate)
            .Take(2)
            .ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(x=>x.Mgr != null).ToList(); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = emps.All(x=>x.Sal > 500); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.SelectMany(e=>
            depts.Where(d => d.DeptNo == e.DeptNo),
            (e, d) => new { e, d })
            .SelectMany(ed =>
                grades.Where(g => ed.e.Sal >= g.Losal && ed.e.Sal <= g.Hisal),
